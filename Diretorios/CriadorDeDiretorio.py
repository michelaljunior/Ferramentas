...
# Data Ultima alteração 12/02/2020
# Erno Soluções © 2020
...
class Programa_Principal():
	def __init__(self, Janela):
		...
		self.Campo_Node.place(x=230, y=38)
...
function CriarJanela () {
	...
	Janela.loadFile('Html/index.html');
	//Janela.setMenu(null);
};
...
'''
				...
				arquivo = open(f'{Diretorio}\\{NomeProjeto}\\Html\\index.html', 'w')
				arquivo.close()
				
				arquivo = open(f'{Diretorio}\\{NomeProjeto}\\Estilo\\Padrao.css', 'w')
				arquivo.close()
